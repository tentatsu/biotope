...
### Biotope開発における開発者のメリット
Biotope開発において、仕様変更対応は開発者にとってモチベーションを下げる要員になりえるのはそのとおりである。  
しかしながら仕様変更期間は開発者にとっては、「成果物の振り返りを行う期間」としての使い方をすると捉えても良いものとする。  
一般に結合テストでは単体レベルの不具合は大いに残っていることが多く、開発者は近視眼的になりがちでその不具合に気付けないことが多い。  
ここで全体を俯瞰して見ることが出来る期間を取ることで、思った以上にバグが発生していることに気付くことが出来るだろう。
